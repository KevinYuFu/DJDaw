...
export const THEMES: readonly Theme[] = [
  ...
  theme('blossom', 'Blossom', 'Dark plum with candy pink. Soft, and still a night theme.', {
    'bg-app': '#262029',
    'bg-panel': '#2f2833',
    'bg-panel-2': '#372f3c',
    'bg-raised': '#423949',
    'bg-raised-hover': '#4f4557',
    'bg-pressed': '#2a2430',
    'bg-sunken': '#221c26',
    'bg-waveform': '#1a151e',
    border: '#5f5369',
    'border-soft': '#413848',
    'border-strong': '#83718d',
    text: '#f7eff7',
    'text-dim': '#cdbad1',
    'text-faint': '#ac99b1',
    'text-inverse': '#241e28',
    accent: '#f093d0',
    'accent-dim': '#8c3f70',
    'accent-glow': 'rgba(240, 147, 208, 0.42)',
    'deck-a': '#f093d0',
    'deck-b': '#f5c46b',
    'deck-c': '#8ee0b8',
    'deck-d': '#b79cf5',
    play: '#7fe0a8',
    'play-glow': 'rgba(127, 224, 168, 0.45)',
    cue: '#f5c46b',
    'cue-glow': 'rgba(245, 196, 107, 0.4)',
    danger: '#f0768f',
    loop: '#f5c46b',
    'wave-low': '#8b74ec',
    'wave-mid': '#f093d0',
    ...
    'chrome-hi': '#4c4254',
    'chrome-lo': '#2a2430',
    overlay: 'rgba(255, 220, 245, 0.06)',
    'overlay-strong': 'rgba(255, 220, 245, 0.12)',
    thumb: '#4b4153',
    'thumb-hover': '#63566d',
    playhead: '#fdf2fa',
    'grid-beat': 'rgba(248, 220, 240, 0.10)',
    'grid-bar': 'rgba(248, 220, 240, 0.26)',
    'grid-phrase': 'rgba(252, 230, 246, 0.44)',
    'clip-body': 'rgba(160, 108, 150, 0.24)',
    'clip-body-on': 'rgba(214, 130, 190, 0.32)',
    'clip-head': 'rgba(178, 122, 166, 0.44)',
    'clip-head-on': 'rgba(240, 147, 208, 0.6)',
    'clip-edge': 'rgba(206, 178, 208, 0.45)',
    'clip-edge-on': 'rgba(250, 176, 224, 0.95)',
    'clip-text': 'rgba(255, 245, 252, 0.92)'
  })
]
